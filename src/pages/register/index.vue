...
import {validateEmail,validateRepeatpassword} from "./registerValidate";
    ...
    <div class="register-main">
      <div class="top-view">
        ...
        <el-form :model="form" label-width="auto" ref="ruleFormRef" :rules="rules" >
          <el-form-item label="用户名" prop="userName" class="app-portrait-form-item  app-form-item-after leftWidth m-b-[16px]">
            <el-input  v-model="form.userName" clearable class="app-form-input"></el-input>
          </el-form-item>
